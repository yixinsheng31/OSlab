               ...
               bool share)
{
    ...
    do
    {
        ...
        if (*ptep & PTE_V)
        {
             ...
             */
            void *src_kvaddr = page2kva(page); // (1) find src_kvaddr
            void *dst_kvaddr = page2kva(npage); // (2) find dst_kvaddr
            memcpy(dst_kvaddr, src_kvaddr, PGSIZE); // (3) memory copy
