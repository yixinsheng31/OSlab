...
exit(int error_code) {
  ...
  8000d4:	5c850513          	addi	a0,a0,1480 # 800698 <main+0x1a0>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80012c:	58878793          	addi	a5,a5,1416 # 8006b0 <main+0x1b8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	560a8a93          	addi	s5,s5,1376 # 8006e4 <main+0x1ec>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800190:	774b8b93          	addi	s7,s7,1908 # 800900 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e6:	2fe60613          	addi	a2,a2,766 # 8006e0 <main+0x1e8>
  ...
  8003f8:	2dc60613          	addi	a2,a2,732 # 8006d0 <main+0x1d8>
  ...
  80040a:	2c240413          	addi	s0,s0,706 # 8006c8 <main+0x1d0>
  ...
  800494:	23840413          	addi	s0,s0,568 # 8006c8 <main+0x1d0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004aa:	223a0a13          	addi	s4,s4,547 # 8006c9 <main+0x1d1>
...
int main(void) {
  ...
  8004fe:	4ce50513          	addi	a0,a0,1230 # 8009c8 <error_string+0xc8>
int main(void) {
  800502:	f822                	sd	s0,48(sp)
  800504:	fc06                	sd	ra,56(sp)
  800506:	f426                	sd	s1,40(sp)
  800508:	f04a                	sd	s2,32(sp)
  80050a:	ec4e                	sd	s3,24(sp)
  80050c:	00001417          	auipc	s0,0x1
  800510:	af440413          	addi	s0,s0,-1292 # 801000 <test_array.0>
    cprintf("COW Test Starting...\n");
  800514:	b2dff0ef          	jal	ra,800040 <cprintf>
  800518:	8722                	mv	a4,s0
  80051a:	4781                	li	a5,0
    for (int i = 0; i < len; i++) {
  80051c:	3e800693          	li	a3,1000
        arr[i] = i * multiplier;
  800520:	c31c                	sw	a5,0(a4)
    for (int i = 0; i < len; i++) {
  800522:	0647879b          	addiw	a5,a5,100
  800526:	0711                	addi	a4,a4,4
  800528:	fed79ce3          	bne	a5,a3,800520 <main+0x28>
  ...
  800530:	4b450513          	addi	a0,a0,1204 # 8009e0 <error_string+0xe0>
  800534:	b0dff0ef          	jal	ra,800040 <cprintf>
    
    int child_pid = fork();
  800538:	ba7ff0ef          	jal	ra,8000de <fork>
  80053c:	84aa                	mv	s1,a0
    
    if (child_pid == 0) {
  80053e:	c151                	beqz	a0,8005c2 <main+0xca>
            exit(-2);
        }
  ...
  800540:	12a05963          	blez	a0,800672 <main+0x17a>
        // 父进程执行路径
        int child_status = 0;
        waitpid(child_pid, &child_status);
  800544:	006c                	addi	a1,sp,12
        int child_status = 0;
  800546:	c602                	sw	zero,12(sp)
        waitpid(child_pid, &child_status);
  800548:	b99ff0ef          	jal	ra,8000e0 <waitpid>
        
        if (child_status == 0) {
  80054c:	45b2                	lw	a1,12(sp)
  80054e:	c1bd                	beqz	a1,8005b4 <main+0xbc>
            cprintf("Child completed successfully\n");
        } else {
            cprintf("Child failed with code %d\n", child_status);
  800550:	00000517          	auipc	a0,0x0
  800554:	5b050513          	addi	a0,a0,1456 # 800b00 <error_string+0x200>
  ...
  800560:	5c450513          	addi	a0,a0,1476 # 800b20 <error_string+0x220>
  800564:	addff0ef          	jal	ra,800040 <cprintf>
    int total = 0;
  800568:	4481                	li	s1,0
  80056a:	00001717          	auipc	a4,0x1
  80056e:	abe70713          	addi	a4,a4,-1346 # 801028 <test_array.0+0x28>
        total += arr[i];
  800572:	401c                	lw	a5,0(s0)
    for (int i = 0; i < len; i++) {
  800574:	0411                	addi	s0,s0,4
        total += arr[i];
  800576:	9cbd                	addw	s1,s1,a5
    for (int i = 0; i < len; i++) {
  800578:	fee41de3          	bne	s0,a4,800572 <main+0x7a>
  ...
  800582:	5ca50513          	addi	a0,a0,1482 # 800b48 <error_string+0x248>
  800586:	abbff0ef          	jal	ra,800040 <cprintf>
        
        // COW机制应保证父子进程数据独立
        if (parent_sum == 4500 && child_status == 0) {
  80058a:	6785                	lui	a5,0x1
  80058c:	19478793          	addi	a5,a5,404 # 1194 <_start-0x7fee8c>
  800590:	00f49463          	bne	s1,a5,800598 <main+0xa0>
  800594:	47b2                	lw	a5,12(sp)
  800596:	c7e1                	beqz	a5,80065e <main+0x166>
            cprintf("COW Test PASSED!\n");
        } else {
            cprintf("COW Test FAILED!\n");
  800598:	00000517          	auipc	a0,0x0
  80059c:	5f050513          	addi	a0,a0,1520 # 800b88 <error_string+0x288>
  ...
  8005a6:	70e2                	ld	ra,56(sp)
  8005a8:	7442                	ld	s0,48(sp)
  8005aa:	74a2                	ld	s1,40(sp)
  8005ac:	7902                	ld	s2,32(sp)
  8005ae:	69e2                	ld	s3,24(sp)
  8005b0:	6121                	addi	sp,sp,64
  8005b2:	8082                	ret
            cprintf("Child completed successfully\n");
  8005b4:	00000517          	auipc	a0,0x0
  8005b8:	52c50513          	addi	a0,a0,1324 # 800ae0 <error_string+0x1e0>
  8005bc:	a85ff0ef          	jal	ra,800040 <cprintf>
  8005c0:	bf71                	j	80055c <main+0x64>
        cprintf("Child: reading parent's data...\n");
  8005c2:	00000517          	auipc	a0,0x0
  8005c6:	43e50513          	addi	a0,a0,1086 # 800a00 <error_string+0x100>
  8005ca:	a77ff0ef          	jal	ra,800040 <cprintf>
    for (int i = 0; i < len; i++) {
  8005ce:	00001997          	auipc	s3,0x1
  8005d2:	a5a98993          	addi	s3,s3,-1446 # 801028 <test_array.0+0x28>
        cprintf("Child: reading parent's data...\n");
  8005d6:	00001797          	auipc	a5,0x1
  8005da:	a2a78793          	addi	a5,a5,-1494 # 801000 <test_array.0>
    int total = 0;
  8005de:	4901                	li	s2,0
        total += arr[i];
  ...
  8005e2:	0791                	addi	a5,a5,4
        total += arr[i];
  8005e4:	0127093b          	addw	s2,a4,s2
    for (int i = 0; i < len; i++) {
  8005e8:	ff379ce3          	bne	a5,s3,8005e0 <main+0xe8>
        cprintf("Child: sum before write = %d\n", initial_sum);
  8005ec:	85ca                	mv	a1,s2
  8005ee:	00000517          	auipc	a0,0x0
  8005f2:	43a50513          	addi	a0,a0,1082 # 800a28 <error_string+0x128>
  8005f6:	a4bff0ef          	jal	ra,800040 <cprintf>
        if (initial_sum != 4500) {
  8005fa:	6785                	lui	a5,0x1
  8005fc:	19478793          	addi	a5,a5,404 # 1194 <_start-0x7fee8c>
  800600:	08f91163          	bne	s2,a5,800682 <main+0x18a>
        cprintf("Child: writing data (trigger COW)...\n");
  800604:	00000517          	auipc	a0,0x0
  800608:	46c50513          	addi	a0,a0,1132 # 800a70 <error_string+0x170>
  80060c:	a35ff0ef          	jal	ra,800040 <cprintf>
  800610:	00001717          	auipc	a4,0x1
  800614:	9f070713          	addi	a4,a4,-1552 # 801000 <test_array.0>
  800618:	4781                	li	a5,0
    for (int i = 0; i < len; i++) {
  80061a:	7d000693          	li	a3,2000
        arr[i] = i * multiplier;
  80061e:	c31c                	sw	a5,0(a4)
    for (int i = 0; i < len; i++) {
  800620:	0c87879b          	addiw	a5,a5,200
  800624:	0711                	addi	a4,a4,4
  800626:	fed79ce3          	bne	a5,a3,80061e <main+0x126>
        total += arr[i];
  80062a:	401c                	lw	a5,0(s0)
    for (int i = 0; i < len; i++) {
  80062c:	0411                	addi	s0,s0,4
        total += arr[i];
  80062e:	9cbd                	addw	s1,s1,a5
    for (int i = 0; i < len; i++) {
  800630:	ff341de3          	bne	s0,s3,80062a <main+0x132>
        cprintf("Child: sum after write = %d\n", modified_sum);
  800634:	85a6                	mv	a1,s1
  800636:	00000517          	auipc	a0,0x0
  80063a:	46250513          	addi	a0,a0,1122 # 800a98 <error_string+0x198>
  80063e:	a03ff0ef          	jal	ra,800040 <cprintf>
        if (modified_sum != 9000) {
  800642:	6789                	lui	a5,0x2
  800644:	32878793          	addi	a5,a5,808 # 2328 <_start-0x7fdcf8>
  800648:	02f48263          	beq	s1,a5,80066c <main+0x174>
            cprintf("Child: ERROR - sum should be 9000\n");
  80064c:	00000517          	auipc	a0,0x0
  800650:	46c50513          	addi	a0,a0,1132 # 800ab8 <error_string+0x1b8>
  800654:	9edff0ef          	jal	ra,800040 <cprintf>
            exit(-2);
  800658:	5579                	li	a0,-2
  80065a:	a6fff0ef          	jal	ra,8000c8 <exit>
            cprintf("COW Test PASSED!\n");
  80065e:	00000517          	auipc	a0,0x0
  800662:	51250513          	addi	a0,a0,1298 # 800b70 <error_string+0x270>
  800666:	9dbff0ef          	jal	ra,800040 <cprintf>
  80066a:	bf2d                	j	8005a4 <main+0xac>
        exit(0);
  80066c:	4501                	li	a0,0
  80066e:	a5bff0ef          	jal	ra,8000c8 <exit>
        cprintf("fork failed\n");
  800672:	00000517          	auipc	a0,0x0
  800676:	52e50513          	addi	a0,a0,1326 # 800ba0 <error_string+0x2a0>
  80067a:	9c7ff0ef          	jal	ra,800040 <cprintf>
        return -1;
  80067e:	557d                	li	a0,-1
  800680:	b71d                	j	8005a6 <main+0xae>
            cprintf("Child: ERROR - sum should be 4500\n");
  800682:	00000517          	auipc	a0,0x0
  800686:	3c650513          	addi	a0,a0,966 # 800a48 <error_string+0x148>
  80068a:	9b7ff0ef          	jal	ra,800040 <cprintf>
            exit(-1);
  80068e:	557d                	li	a0,-1
  800690:	a39ff0ef          	jal	ra,8000c8 <exit>
